...
render_templ "${here}/chaos-template/network-delay-tiflash-template.yaml" "${here}/${sub_dir}/network-delay-tiflash.yaml" "${render_str}"
...
render_templ "${here}/chaos-template/network-corrupt-tiflash-template.yaml" "${here}/${sub_dir}/network-corrupt-tiflash.yaml" "${render_str}"
...
render_templ "${here}/chaos-template/network-duplicate-tiflash-template.yaml" "${here}/${sub_dir}/network-duplicate-tiflash.yaml" "${render_str}"
...
render_templ "${here}/chaos-template/network-loss-tiflash-template.yaml" "${here}/${sub_dir}/network-loss-tiflash.yaml" "${render_str}"
